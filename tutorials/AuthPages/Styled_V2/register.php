<?php
	...
	$account = new Account($con); //we have put it here, because we can call it in the **register-handler.php and login-handler.php** as well.
...
<?php
	...
	//We have added this because if user pressed register button then if there is an error then the page must return register form again otherwise it will return login form.
